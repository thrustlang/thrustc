    ...
    while let Some(message) = self::read_message(&mut input) {
        ...
        match method {
            ...
            "textDocument/didOpen" => {
                ...
                let document: Option<&crate::documents::Document> = documents.get(&uri);
            ...
            "textDocument/hover" => {
                ...
                let result: Value = crate::hover::hover(&documents, &analysis, &payload);
                let response: Value = serde_json::json!({
                    "jsonrpc": "2.0",
                    "id": id,
                    "result": result
            ...
            "textDocument/completion" => {
                ...
                let items: Vec<Value> =
                    crate::completion::complete(&documents, &analysis, &payload);
