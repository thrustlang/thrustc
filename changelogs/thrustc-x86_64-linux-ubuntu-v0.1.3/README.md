...
## [thrustc-aarch64-macos-v0.1.1] - 2026-05-11

### Bug Fixes
- **project-visual**: `fix(project-visual)` Removing unnecesary details on README.md ([`093b1fe`](https://github.com/thrustlang/thrustc/commit/093b1fe888c58e144c074567b9842ce3415b2cb4))
- **project-visual**: `fix(project-visual)` Reshaping README.md ([`f09cbdd`](https://github.com/thrustlang/thrustc/commit/f09cbdd6c062e1564fcee1684ed8a910d274a87b))
- **project-visual**: `fix(project-visual)` I fixed some typos found on README.md ([`de4c5db`](https://github.com/thrustlang/thrustc/commit/de4c5dbdee29f1fe34a05a44fe5cc1d4a387f28f))
- **project**: `fix(project)` I fixed an issue that involucrate `zstd` on the MacOS action. ([`906809a`](https://github.com/thrustlang/thrustc/commit/906809a1c997e7791fc6165f06d6ca3238ba1315))
- **project**: `fix(project)` I fixed some issue regarding C++ headers on the MacOS action. ([`afc960b`](https://github.com/thrustlang/thrustc/commit/afc960b213ee59791d147abf12fde5fa41fd723f))
- **project**: `fix(project)` I fixed some issue regarding C++ headers on the MacOS action. ([`d364d0c`](https://github.com/thrustlang/thrustc/commit/d364d0c92c58712923cddc0708dbce342f1b79cb))
- **project**: `fix(project)` I fixed some issue found on the GCC C++ headers on the MacOS workflow. ([`c26117a`](https://github.com/thrustlang/thrustc/commit/c26117afb36ef476ae199e03f92cb93d4b83b630))
- **project**: `fix(project)` I fixed an issue on MacOS action regarding C++ headers. ([`9db8e3c`](https://github.com/thrustlang/thrustc/commit/9db8e3cfd6a7dcfa0dceb40d06a9853da067d310))
- **project**: `fix(project)` I fixed a build error on the MacOS workflow. ([`a979488`](https://github.com/thrustlang/thrustc/commit/a979488398e550d90ace4a8f38d14161f806261b))
- **project**: `fix(project)` I fixed some issue using stdlibc++ of GCC on the MacOS workflow. ([`df2bd9a`](https://github.com/thrustlang/thrustc/commit/df2bd9a91a7b4cc51ee0b609045052dd7cd335ad))
- **project**: `fix(project)` I fixed some issue found on the MacOS workflow. ([`9ae7d78`](https://github.com/thrustlang/thrustc/commit/9ae7d78a88682cece50f71c09314988b189f2dfe))
- **project**: `fix(project)` I fixed the build process that happens when you're building LLVM 17 from the source on the MacOS GitHub action. ([`691fc80`](https://github.com/thrustlang/thrustc/commit/691fc80520b0f859d53d34f9c576e8782a76e334))
- **project**: `fix(project)` Adding clang to the installing dependencies phase on the MacOS action. ([`ba78a0b`](https://github.com/thrustlang/thrustc/commit/ba78a0bcb493c2f68756dbca9094d7df8d0802b0))
- **project**: `fix(project)` Adding installing Rust phase on the MacOS action. ([`89a0ba9`](https://github.com/thrustlang/thrustc/commit/89a0ba98047c766a28a2a6b104fa370a10a952bc))


### Documentation
- **project-visual**: `(feat(project), feat(project-visual))` Adding the required guide for build the cargo dependencies to build the compiler. `README.md` ([`1c9acf5`](https://github.com/thrustlang/thrustc/commit/1c9acf5d4d8d2db430067d6f210f49a1f718a8bf))
- **project-visual**: `feat(project-visual)` Updating the compiler `COMMANDS & FLAGS` section. ([`74f0fe7`](https://github.com/thrustlang/thrustc/commit/74f0fe748c90e3c7efe7454a1a00026b548a84fa))
- **project-visual**: `feat(project-visual)` Introducing an early compiler changelog's system. ([`0b17fd0`](https://github.com/thrustlang/thrustc/commit/0b17fd0644e630630c2005b283478a522fadc872))


### Features
- **frontend**: `feat(frontend)` I added pretty and non-pretty formatted json support on compiler emission and show-on console flags. ([`981ae2b`](https://github.com/thrustlang/thrustc/commit/981ae2b3d135a9f2803a62e13d37e29ba529c599))
- **frontend**: `feat(frontend)` jacked chad compiler is capable of compile 100k LOC in 0.35ms, who is clang (kidding). ([`0b676f2`](https://github.com/thrustlang/thrustc/commit/0b676f251f3c16cbf56ea0ec0ed838085a710d1e))


### Project
- **project**: `feat(project)` Adding zstd installation on MacOS action. ([`27f1c63`](https://github.com/thrustlang/thrustc/commit/27f1c63719a17d6cc8d27ae350e6c6715b4d1db2))
- **project**: `feat(project)` Adding MacOS github action support. ([`0c5c73e`](https://github.com/thrustlang/thrustc/commit/0c5c73ed2f309582a937c1898644388573b2cdc8))


## [thrustc-x86_64-windows-msvc-v0.1.0] - 2026-05-05

### Bug Fixes
- **project**: `fix(project)` I fixed some critical issue found on the windows action. ([`8caa5a4`](https://github.com/thrustlang/thrustc/commit/8caa5a4960c399a21555a621beda2e1f2ece3305))
- `fix(llvm_codegen)` I fixed some issues found on constant type cast, when the compiler faces a integer to float type cast. ([`ae54f1e`](https://github.com/thrustlang/thrustc/commit/ae54f1eb330f24aedce36c98ab2d3cf7861505a4))
- **project**: `fix(project)` I fixed the windows worflow. ([`6565d70`](https://github.com/thrustlang/thrustc/commit/6565d700a395e4354a62bde9c4f241ca7d234c50))
- **project**: `fix(project)` Hot fix on LLVM download system in windows workflow. ([`125db1e`](https://github.com/thrustlang/thrustc/commit/125db1e1404f1091cac9dc022bd4857a47f5ff5c))
- **project**: `fix(project)` Hot fix for windows workflow. ([`d0ccca7`](https://github.com/thrustlang/thrustc/commit/d0ccca72f2960a8712ef134ff19ffe9e68534375))
- **project**: `fix(project)` I fixed the windows workflow. ([`fc046b2`](https://github.com/thrustlang/thrustc/commit/fc046b2e461f406743b91607a814736b05c4a650))
- **project**: `fix(project)` I fixed identation on the windows workflow. ([`9e92c64`](https://github.com/thrustlang/thrustc/commit/9e92c640f0731c8d63dbf2f7b4ab620b856759ae))
- **project**: `fix(project)` I fixed the tag name when you're releasing a version of the compiler. ([`db327b7`](https://github.com/thrustlang/thrustc/commit/db327b7671428b1540cd2e8b90755e630873c4fa))


### Project
- **project**: `feat(project)` Add support to windows worflow. ([`4d5fd28`](https://github.com/thrustlang/thrustc/commit/4d5fd28a434a45b7d67603243e34186e4fa6656e))
- **project**: `feat(project)` I improved the github action to build automatically the compiler. ([`c2778cb`](https://github.com/thrustlang/thrustc/commit/c2778cbffb4e3cbb9c1207b14af24d3341fb9a1f))
