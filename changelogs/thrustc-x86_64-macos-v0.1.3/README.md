...
### Project
- **project**: `feat(project)` Adding Neovim One Dark hightlighting support. ([`a282105`](https://github.com/thrustlang/thrustc/commit/a282105e7dca0b673a1bd26567bb5111852c8ef2))


## [thrustc-x86_64-windows-msvc-v0.1.3] - 2026-06-07

### Documentation
- **project-visual**: `feat(project-visual)` Adding a more clear way to notice the existence of compiler compiled binaries on README.md ([`0df5012`](https://github.com/thrustlang/thrustc/commit/0df5012202516755856168f06723aa8ae2259758))


### Project
- **project**: `feat(project)` Adding git reporsitory synchronization on release-changelog scripts. ([`e513f9d`](https://github.com/thrustlang/thrustc/commit/e513f9da62beba91ad57256463c2b6f06e1da1f0))
