...
## [thrustc-x86_64-linux-ubuntu-v0.1.8] - 2026-08-15

### Bug Fixes
- **frontend**: (fix(llvm_backend), fix(frontend)) Hot fix on System-V struct and arrays classification and coerce classification and hot fix on typechecker with void type. Pushing new version. ([`d8434e4`](https://github.com/thrustlang/thrustc/commit/d8434e43496363a92fae38e92400600d0e1b7207))
- **project**: Fix(project) Hot fix on release changelog, specific .fish with issue on command line formatting. ([`559b28d`](https://github.com/thrustlang/thrustc/commit/559b28d081182c8baf94298908ee85870e0a65b3))
- **project**: Fix(project) Hot fix on version set for Cargo.toml in fish shell. ([`6f16587`](https://github.com/thrustlang/thrustc/commit/6f165879426d21f0f2ef60cbff1a7c9e8ed85912))


### Features
- **llvm_backend**: Feat(llvm_backend) Adding more support for atomic ordering, structs, arrays and fixed arrays are still missing it. ([`685c6d4`](https://github.com/thrustlang/thrustc/commit/685c6d4870d8a3420318f20b81223203196df25d))
- **frontend**: Feat(frontend) Added unstable compiler warnings. ([`bae05f7`](https://github.com/thrustlang/thrustc/commit/bae05f7a5b340ecbfc6855263383bd8fdf3834bc))


### Project
- **project**: Feat(project) Adding the llvm linker wrapper bindings. ([`f1f4f5e`](https://github.com/thrustlang/thrustc/commit/f1f4f5ec29bc5da38a098580fb379f440d44c7ce))


## [thrustc-aarch64-macos-v0.1.7] - 2026-08-14
