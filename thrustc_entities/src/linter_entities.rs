...
pub type LinterConstantInfo = (Span, bool, bool);
...
pub type LinterAssemblerFunctionInfo<'linter> = (Span, bool, bool);
...
pub type LinterEnumsFieldsInfo<'linter> =
    (HashMap<&'linter str, LinterEnumFieldInfo>, Span, bool, bool);
