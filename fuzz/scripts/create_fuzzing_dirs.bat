...
set "DIRS=corpus_stable\llvm-codegen-top-level corpus_stable\llvm-codegen-local corpus_stable\llvm-codegen-local-loops corpus_stable\pipeline corpus_unstable\llvm-codegen-top-level corpus_unstable\llvm-codegen-local corpus_unstable\llvm-codegen-local-loops corpus_unstable\pipeline corpus_universal\lexer fuzz_reproduce_logs fuzz_pipeline"
